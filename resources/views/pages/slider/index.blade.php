...
@section('title', 'Cireundeu Store | Slider')
...
@section('modal')
    <div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" action="/carousels-import" method="POST">
                            @csrf
                            <div class="mb-3">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form enctype="multipart/form-data" action="{{ $Action }}/save-create" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Image URL (1440px X 481px)</label>
        ...
        @foreach ($carousels as $carousel)
            <div class="modal fade" id="editModal{{ $carousel->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
                aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="{{ $Action }}/save-edit/{{ $carousel->id }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="mb-3">
                                    <img src="{{ $carousel->image }}" class="img-responsive img-rounded"
                                ...
                                {{-- <div class="mb-3">
                                    ...
                                    <input class="form-control" type="file" id="image" name="image"
                                        value="{{ asset('assets/images/carousels/' . $carousel->image) }}">
                                </div> --}}
...
@section('content')
    <div class="page-heading d-md-flex justify-content-between">
        ...
        <div>
            ...
            <a href="/carousels-export" class="btn btn-warning">Export</a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" type="button" class="btn btn-primary mx-2" data-bs-toggle="modal"
                                            data-bs-target="#editModal{{ $carousel->id }}">
                                        ...
                                        <a href="{{ $Action }}/{{ $carousel->id }}" class=" mx-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
