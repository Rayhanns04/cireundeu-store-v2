    ...
    <div class="page-heading d-md-flex justify-content-between">
        ...
        <div>
            ...
            <button type="submit" class="btn btn-danger disabled" data-bs-toggle="tooltip" data-bs-placement="bottom"
                title="Delete All Selected" id="massDelete"><i data-feather="trash-2"></i></button>
        </div>
    </div>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-sm">
                        ...
                        <tbody>
                            ...
                            @endif
                            @foreach ($products as $product)
                                <tr id="salary-{{ $product->id }}">
                                    <td class="text-bold-500">
                                        <div class="form-check form-check-inline">
                                            <input data-id="{{ $product->id }}" type="checkbox" name="ids[]"
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ $Action }}/{{ $product->id }}" class=" mx-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
